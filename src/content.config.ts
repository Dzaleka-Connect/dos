...
const encyclopediaSchema = z.object({
  ...
  entryType: z.enum(['overview', 'place', 'organization', 'person', 'event', 'film', 'topic']),
  ...
  schemaType: z.enum(['Place', 'Organization', 'NGO', 'Person', 'Event', 'Movie', 'RadioStation', 'EducationalOrganization', 'MedicalOrganization', 'Article']).optional(),
  film: z.object({
