---
slug: unhcr-dzaleka-luwani-sens-2016
title: UNHCR standardised expanded nutrition survey for Dzaleka, Luwani, and host communities (2016)
summary: UNHCR microdata release covering nutrition, food security, mosquito net coverage, and WASH indicators across Dzaleka, Luwani, and surrounding host communities in 2016.
description:
...
coverage: Dzaleka and Luwani refugee camps and nearby host communities in Malawi
updateCadence: Static survey release; verify upstream metadata before reuse
tags:
  - unhcr
  - microdata
  - nutrition
...
distributions:
  - title: UNHCR catalog entry
    description: Official study landing page with metadata and access information for the 2016 SENS release.
    href: https://microdata.unhcr.org/index.php/catalog/660
    format: HTML
    access: External
  - title: UNHCR Dzaleka microdata search
    description: Search results page for related Dzaleka microdata entries across different years and topics.
    href: https://microdata.unhcr.org/index.php/catalog?page=1&sk=Dzaleka&sort_by=rank&sort_order=desc&ps=15
    format: HTML
    access: External
recordMode: Nutrition survey microdata
lastUpdated: 2022-05-18
sourceNote: Curated from the public UNHCR Microdata Library entry for reference ID UNHCR_MWI_2016_SENS_v2.1.
license: UNHCR microdata terms and confidentiality conditions apply
maintainer: Dzaleka Online Services editorial team
sourceUrl: https://microdata.unhcr.org/index.php/catalog/660
temporalCoverage: March 2016 fieldwork; metadata page updated May 2022
methodology:
...
references:
  - title: UNHCR Microdata Library entry for UNHCR_MWI_2016_SENS_v2.1
    href: https://microdata.unhcr.org/index.php/catalog/660
    note: Official metadata page for the 2016 SENS release.
  - title: UNHCR Dzaleka search results
    href: https://microdata.unhcr.org/index.php/catalog?page=1&sk=Dzaleka&sort_by=rank&sort_order=desc&ps=15
    note: Good starting point for finding earlier and later Dzaleka survey releases.
